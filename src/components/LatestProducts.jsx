  ...
  return (
    <>
      <div className=" pb-7 mt-4   bg-slate-950 flex flex-col gap-6 flex-1">
        <h1 className="text-3xl font-medium lg:pl-7 pl-0 text-center lg:text-left text-blue-500">
          Legújabb termékek
        </h1>
        ...
        <div className="flex justify-center mt-4 items-center">
          <div
            ...
            className="flex gap-2 items-center p-3 rounded-xl text-white bg-blue-600"
          >
