        ...
        <div className="flex-1 flex flex-col gap-6 text-center lg:text-left items-center lg:items-start">
          ...
          <div className="border items-center gap-2 border-blue-500/20 flex w-fit px-2 py-1 rounded-full bg-blue-500/10">
            ...
            <p className="text-sm font-medium text-blue-400 tracking-wide">
              Csak DSZC Baross Gábor diákok számára
            </p>
          </div>
          ...
          <p className="text-slate-400 text-base leading-relaxed max-w-md">
            Vásárolj tudatosan, adj el egyszerűen! Egy hely, ahol a régi
            kedvencedből más új kincse válhat.
          </p>
          ...
          <div className="flex flex-wrap justify-center lg:justify-start gap-4 mt-2">
            {[
              ...
              <div
                key={i}
                className="border flex flex-col items-center bg-slate-900 px-6 py-3 rounded-xl border-slate-700/50"
              >
