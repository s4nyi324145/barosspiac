      ...
      <div className="flex flex-col flex-1 p-8 text-white gap-8">
        ...
        <div className="border-b border-slate-800 pb-5">
          ...
          <p className="text-slate-500 text-sm mt-1">
            Kezeld a jelszavad és a fiókod biztonságát
          </p>
        </div>
        ...
        <div className="bg-slate-800/40 border border-slate-700/60 rounded-2xl p-6 flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-1.5 mt-1">
                <div className="flex gap-1">
                  {[1, 2, 3].map((i) => (
                    <div
                      key={i}
                      className={`h-1 flex-[0.1] rounded-full transition-all duration-300 ${
                        i <= passwordStrength
                          ? passwordStrength === 1
                            ? "bg-red-500"
                            : passwordStrength === 2
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <div
              className={`flex items-center gap-3 bg-slate-800/60 border rounded-xl px-4 py-2.5 focus-within:ring-2 transition-all duration-200 ${
