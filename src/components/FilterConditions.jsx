...
export default function FilterConditions({ filter, setFilter }) {
  const conditions = [
    {
      name: "Új",
      desc: "Soha nem volt használva, eredeti csomagolásban vagy címkével.",
    },
    {
      name: "Kiváló",
      desc: "Alig használt, szinte hibátlan állapot, minimális nyomok.",
    },
    {
      name: "Jó",
      desc: "Láthatóan használt de jól funkcionál, kisebb kopásnyomok lehetnek.",
    },
    {
      name: "Kielégítő",
      desc: "Erősen használt, látható hibák vagy kopás, de még működőképes.",
    },
  ];
