      ...
      <div className="flex flex-col flex-1 p-8 text-white gap-8">
        ...
        <div className="border-b border-slate-800 pb-5">
          ...
          <p className="text-slate-500 text-sm mt-1">
            Állítsd be milyen email értesítéseket szeretnél kapni
          </p>
        </div>
          ...
          {[
            {
              ...
              icon: Mail,
              label: "Új üzenet",
              desc: "Értesítés ha valaki üzenetet küld neked",
            },
            {
              key: "newRating",
              icon: Star,
              label: "Új értékelés",
              desc: "Értesítés ha valaki értékel téged",
            },
            {
              key: "productSold",
              icon: Tag,
              label: "Termék eladva",
              desc: "Értesítés ha valaki megveszi a hirdetésed",
            },
          ].map((item, index, arr) => (
            <div
              key={item.key}
              className={`flex items-center justify-between py-4 ${index !== arr.length - 1 ? "border-b border-slate-700/40" : ""}`}
            >
        ...
        <div className="flex justify-end">
          <button
            ...
            className="flex items-center gap-2 text-sm font-semibold text-white bg-blue-600 hover:bg-blue-500 px-6 py-2.5 rounded-xl transition-all duration-200 shadow-lg shadow-blue-600/20"
          >
