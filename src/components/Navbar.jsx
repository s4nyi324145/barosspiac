...
export default function Navbar() {
  ...
  const handleSearch = (e) => {
    if (e.key === "Enter" && searchTerm.trim()) {
      navigate(`/browser?search=${searchTerm.trim()}`);
      setSearchTerm("");
    }
  };
    ...
    <>
      <div className="bg-slate-900 border-b border-slate-800">
        <div className="p-4 flex items-center justify-between gap-4">
          ...
          <p
            onClick={() => navigate("/")}
            className="text-white cursor-pointer font-bold shrink-0"
          >
          ...
          {user ? (
            <div className="flex items-center gap-2">
              ...
              <a
                href="/upload"
                className="hidden md:flex items-center gap-2 text-sm font-semibold text-white bg-blue-600 hover:bg-blue-500 px-4 py-2 rounded-xl transition-all duration-200 shadow-lg shadow-blue-600/20"
              >
              ...
              <a
                href="/upload"
                className="md:hidden p-2.5 rounded-xl text-white bg-blue-600 hover:bg-blue-500 transition-all duration-200"
              >
              ...
              <a
                href="/likes"
                className="hidden md:block p-2.5 rounded-xl text-slate-400 hover:text-white hover:bg-slate-800 transition-all duration-200"
              >
                  ...
                  <div className="absolute top-11 right-[-20px] w-48 bg-slate-900 border border-slate-700/60 rounded-2xl shadow-2xl shadow-black/40 overflow-hidden z-50">
                    ...
                    <div className="p-1.5 flex flex-col gap-0.5">
                      <a
                        ...
                        className="flex items-center gap-2.5 px-3 py-2 rounded-xl text-sm text-slate-300 hover:text-white hover:bg-slate-800 transition-all duration-200"
                      >
            ...
            <div className="flex items-center gap-2">
              <a
                href="/login"
                className="hidden md:block text-sm font-medium text-slate-300 hover:text-white border border-slate-700/50 px-4 py-2 rounded-xl hover:bg-slate-800/60 transition-colors duration-200"
              >
                Bejelentkezés
              </a>
        ...
        {menuOpen && (
          <div className="md:hidden bg-slate-900 border-t border-slate-800 px-4 py-3 flex flex-col gap-1">
            <a
              href="/"
              className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm text-slate-300 hover:text-white hover:bg-slate-800 transition-all duration-200"
            >
            ...
            {user ? (
              <>
                ...
                <a
                  ...
                  className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm text-slate-300 hover:text-white hover:bg-slate-800 transition-all duration-200"
                >
                  <User className="w-4 h-4" /> Értesítéseim
                </a>
                <a
                  href="/settings"
                  className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm text-slate-300 hover:text-white hover:bg-slate-800 transition-all duration-200"
              ...
              <>
                ...
                <a
                  href="/register"
                  className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm text-white bg-blue-600 hover:bg-blue-500  transition-all duration-200"
                >
