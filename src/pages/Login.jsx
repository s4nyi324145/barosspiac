      ...
      <div className="relative w-full max-w-md bg-slate-900 border border-slate-700/50 rounded-3xl p-10 shadow-2xl shadow-black/60">
        ...
        <form onSubmit={(e) => handleSubmit(e)}>
          ...
          <div className="mb-6">
            ...
            <div
              className={`flex items-center group ${errorField.includes("psw") ? "border-red-500" : ""} bg-slate-800/60 border border-slate-700/60 rounded-xl px-4 focus-within:border-blue-500 focus-within:ring-2 focus-within:ring-blue-500/20 transition-all duration-200`}
            >
          ...
          <button
            type="submit"
            className={`w-full py-4 rounded-xl text-sm font-semibold text-white tracking-wide transition-all duration-200 ${"bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-500 hover:to-blue-400 shadow-lg shadow-blue-600/30 hover:shadow-blue-500/40 hover:-translate-y-0.5 active:translate-y-0 cursor-pointer"}`}
          >
            Bejelentkezés →
          </button>
        </form>
