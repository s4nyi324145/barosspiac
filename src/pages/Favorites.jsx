...
export default function Favorites() {
  ...
  {
    /*Get all liked products fot the user */
  }
  ...
  {
    /*Delete all liked products for the user */
  }
          ...
          <div className="fixed   inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <div className="bg-slate-900 border animate-[scale-in_0.15s_ease-out]   border-slate-700/60 rounded-2xl p-6 w-full max-w-md flex flex-col gap-5 shadow-2xl">
              ...
              <p className="text-slate-400 text-sm">
                Biztosan törölni szeretnéd az összes kedvenc hirdetésedet? A
                lista véglegesen kiürül.
              </p>
