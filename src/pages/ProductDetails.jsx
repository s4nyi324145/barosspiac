            ...
            {!productDetail[0] ? (
                ...
                <>
                    ...
                    <div className="flex flex-col lg:flex-row gap-6 md:p-5 p-0  ">
                        <ProductImages is_sold={productDetail[0].is_sold} product_img={productImages} />
                        <ProductDesc getProductDetails={getProductDetails} is_sold={productDetail[0].is_sold} product_id={product_id} productDetail={productDetail[0]} />
                    </div>
