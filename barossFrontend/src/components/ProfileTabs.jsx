...
export default function ProfileTabs({ getUserData,user, owner }) {
    ...
    return (<>
        ...
        <div className={`${activeTab === 'ertekelesek'
                    ...
                    <div className="col-span-5 flex flex-col items-center justify-center py-20 gap-4">
                        ...
                        <div className="flex flex-col gap-1 text-center">
                            ...
                            <p className="text-slate-500 text-sm">
                                {activeTab === 'aktiv' && 'Ez a felhasználó még nem adott fel hirdetést.'}
                                {activeTab === 'eladott' && 'Ez a felhasználó még nem adott el semmit.'}
                                {activeTab === 'ertekelesek' && 'Ezt a felhasználót még nem értékelték.'}
                            </p>
                        </div>
                    </div>
                )}
